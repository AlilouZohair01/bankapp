...
const Testimonials = () => {
  return (
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relaive z-[1]">
      ...
      <div className="flex flex-wrap sm:justify-satrt justify-center w-full feedback-container relative z-[1]">
          {feedback.map((card) =>  (

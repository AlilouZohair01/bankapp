...
const Footer = () => {
  return (
   <section className={` ${styles.paddingY} felx-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className='flex-1 flex flex-col justify-start mr-10'>
        <img src={logo} alt="hoologo" className='w-[266px] h[72px] object-contain'/>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]'>
        <p className='font-poppins font-normal  text-[18px] leading-[27px] text-dimWhite mt-5'>Copyright@ 2024 HooBank. All Rights Reserved.</p>
